...
F {}
E {}
C {inductor2.sym} 840 -540 0 0 {name=L12
m=1
value=1n
footprint=1206
device=inductor2
...
C {iopin.sym} 840 -510 2 0 {name=p11 sig_type=std_logic lab=LB12}
C {iopin.sym} 840 -570 2 0 {name=p12 sig_type=std_logic lab=LA12}
